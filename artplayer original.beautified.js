...
! function (t, e) {
    ...
    function V (t) {
        return t.includes("?") ? V(t.split("?")[0]) : t.includes("#") ? V(t.split("#")[0]) : t.trim()
            .toLowerCase()
            .split(".")
            .pop()
    }
        ...
        init () {
            ...
            t.playbackRate && this.add(function (t) {
                return e => {
                    ...
                    } = e, o = a.map(t => `<span data-value="${t}">${1===t?r.get("Normal"):t.toFixed(1)}</span>`)
                        .join("");
                    return {
                        ...t,
                ...
                return e => {
                    ...
                    } = e, o = a.map(t => `<span data-value="${t}">${"default"===t?r.get("Default"):t}</span>`)
                        .join("");
                    return {
                        ...t,
                ...
                return e => {
                    ...
                    } = e, o = a.map(t => `<span data-value="${t}">${r.get(N(t))}</span>`)
                        .join("");
                    return {
                        ...t,
    ...
    const zt = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]],
        Lt = (() => {
            ...
            function (t) {
                ...
                H(t, "getDataURL", {
                    value: () => new Promise((t, o) => {
                        try {
                            a.width = r.videoWidth, a.height = r.videoHeight, a.getContext("2d")
                                .drawImage(r, 0, 0), t(a.toDataURL("image/png"))
                        } catch (n) {
                            e.show = n, o(n)
                        }
                    })
    ...
    class jt extends dt {
        ...
        update () {
            ...
            e.innerHTML = "", this.activeCues.length && (this.art.emit("subtitleBeforeUpdate", this.activeCues), e.innerHTML = this.activeCues.map((e, r) => e.text.split(/\r?\n/)
                    .filter(t => t.trim())
                    .map(e => `<div class="art-subtitle-line" data-group="${r}">\n                                ${t.escape?B(e):e}\n                            </div>`)
                    .join(""))
                .join(""), this.art.emit("subtitleAfterUpdate", this.activeCues))
        }
        async switch (t, e = {}) {
            const {
                i18n: r,
        ...
        async init (t) {
            ...
            return this.textTrack ? (o(t, ct.subtitle), t.url ? (this.option = t, this.style(t.style), fetch(t.url)
                ...
                .then(t => (r.innerHTML = "", this.url === t || (URL.revokeObjectURL(this.url), this.createTrack("metadata", t)), t))
                .catch(t => {
